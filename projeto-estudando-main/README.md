...
│   ├── index.html, cadastro.html, login.html, painel.html
│   ├── feedback.html, meus-dados.html
├── CSS/                  Folhas de estilo
│   ├── estilo.css        Estilos compartilhados
│   ├── base.css          Base usada por cada página
│   └── *.css              Estilos exclusivos de cada página
├── JS/                   JavaScript compartilhado e específico
│   ├── dados.js, layout.js
│   └── um JS específico para cada página
└── Imagens/              Imagens do site
```

Cada tipo de arquivo fica em sua própria pasta. Os HTMLs carregam CSS de `CSS/` e JavaScript de `JS/`.
Essa divisão facilita estudar uma página por vez sem repetir o design compartilhado.
